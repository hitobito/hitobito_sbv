...
describe Export::Tabular::Groups::Row do
  ...
  context 'any group without values' do
    ...
    it 'returns blank for nil verein attributes' do
  ...
  describe 'Group::Verein without values' do
    ...
    it 'returns unbekannt for nil verein attributes' do
  ...
  describe 'Group::Verein with values' do
    let(:group) { Group::Verein.new(klasse: :erste, unterhaltungsmusik: :oberstufe, besetzung: :brass_band) }

    it 'returns translated values for verein attributes' do
